				...
				<div class="canvas-container">
					...
					<div class="replayBlock">
						...
						<span data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-translate="tooltips" data-bs-original-title="Connecte-toi pour créer un tournoi">
							<button id="tournament" disabled class="btn btn-outline-light fw-bold" value="tournament"><span data-translate="true">Tournoi</span> <i class="bi bi-exclamation-triangle m-2 fw-bold col-6"></i>
							</button>
						</span>
						</div>
					</div>
